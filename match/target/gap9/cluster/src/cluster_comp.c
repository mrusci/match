...
void conv_2d_sparse_4_comp(void* args){
    cluster_kernel* kernel = (cluster_kernel*)args;
    void* im_2_col=kernel->im2col_pt;
    int i_channels=kernel->common_kernel->c_i;
    int i_width=kernel->common_kernel->ix_i
    ...
    //printf("Conv 2d :: I [ C %d IY %d IX %d ] O [ K %d OY %d OX %d ] W [ FY %d FX %d ]\n",i_channels,i_height,i_width,o_channels,o_height,o_width,w_y_height,w_y_width);
    //printf("Conv 2d :: addr I %d O %d W %d\n",kernel->common_kernel->I_pt,kernel->common_kernel->O_pt,kernel->common_kernel->W_pt);
    pulp_nn_sparse_conv_HoWo_parallel1x2_1_1_4(
        kernel->common_kernel->I_pt,
        im_2_col,
        im_2_col, //it should be the sparse one // Not used
        kernel->common_kernel->bias_pt,
        kernel->common_kernel->O_pt,
        kernel->common_kernel->W_pt,
        kernel->common_kernel->W_pt + i_channels * w_y_width * w_y_height, // it should be the sparse one
        kernel->common_kernel->batchnorm_mul,
        kernel->common_kernel->batchnorm_add,
        1,
        kernel->common_kernel->right_shift,
...
void conv_2d_sparse_8_comp(void* args){
    cluster_kernel* kernel = (cluster_kernel*)args;
    void* im_2_col=kernel->im2col_pt;
    int i_channels=kernel->common_kernel->c_i;
    int i_width=kernel->common_kernel->ix_i
    ...
    //printf("Conv 2d :: I [ C %d IY %d IX %d ] O [ K %d OY %d OX %d ] W [ FY %d FX %d ]\n",i_channels,i_height,i_width,o_channels,o_height,o_width,w_y_height,w_y_width);
    //printf("Conv 2d :: addr I %d O %d W %d\n",kernel->common_kernel->I_pt,kernel->common_kernel->O_pt,kernel->common_kernel->W_pt);
    pulp_nn_sparse_conv_HoWo_parallel1x2_1_1_8(
        kernel->common_kernel->I_pt,
        im_2_col,
        im_2_col, //it should be the sparse one // Not used
        kernel->common_kernel->bias_pt,
...
void conv_2d_sparse_16_comp(void* args){
    cluster_kernel* kernel = (cluster_kernel*)args;
    void* im_2_col=kernel->im2col_pt;
    int i_channels=kernel->common_kernel->c_i;
    int i_width=kernel->common_kernel->ix_i
    ...
    //printf("Conv 2d :: I [ C %d IY %d IX %d ] O [ K %d OY %d OX %d ] W [ FY %d FX %d ]\n",i_channels,i_height,i_width,o_channels,o_height,o_width,w_y_height,w_y_width);
    //printf("Conv 2d :: addr I %d O %d W %d\n",kernel->common_kernel->I_pt,kernel->common_kernel->O_pt,kernel->common_kernel->W_pt);
    pulp_nn_sparse_conv_HoWo_parallel1x2_1_1_16(
        kernel->common_kernel->I_pt,
        im_2_col,
        im_2_col, //it should be the sparse one // Not used
        kernel->common_kernel->bias_pt,
...
void cluster_kernel_function_wrapper(cluster_kernel* kernel){
    ...
    else if(kernel->common_kernel->specific_pattern==conv2d_sparse_4)
        pi_team_offload_preset(conv_2d_sparse_4_comp, kernel);
    else if(kernel->common_kernel->specific_pattern==conv2d_sparse_8)
        pi_team_offload_preset(conv_2d_sparse_8_comp, kernel);
    else if(kernel->common_kernel->specific_pattern==conv2d_sparse_16)
        pi_team_offload_preset(conv_2d_sparse_16_comp, kernel);
